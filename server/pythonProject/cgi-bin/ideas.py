...
for idea in range(0, 10):
    print("<br><br><br>")
    print(ideas[idea]["title"] + "<br>")
    print(ideas[idea]['description'] + "<br>")
    print(ideas[idea]['source'] + ", " + ideas[idea]['date'] + "<br>")
    print(str(ideas[idea]['current_profit'] )+ "<br>")
    print(ideas[idea]['goal'] + " " + ideas[idea]['period'] + "<br>")
    print("<a href="+ ideas[idea]['original'] + ">Полная и оригинальная версия</a>")
